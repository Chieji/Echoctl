 ...
 */
/**
 * Animation Variants - Hoisted to module level to prevent re-creation
 */
...
/**
 * Isolated CLI Demo Component
 * Prevents main page re-renders during high-frequency simulation state updates
 */
function CliDemo() {
    ...
    >
      ...
      <div className="rounded-xl border border-border bg-card overflow-hidden shadow-lg">
        ...
        <div className="bg-card p-6 font-mono text-sm h-96 overflow-y-auto">
          ...
          {isRunningDemo && <div className="text-primary animate-pulse">▌</div>}
        </div>
      </div>
