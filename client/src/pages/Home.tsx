...
const FEATURES = [
  ...
  { icon: <Terminal className="h-8 w-8" />, title: 'Threat Detection', description: 'Real-time vulnerability scanning and security analysis across your infrastructure.' },
  { icon: <Terminal className="h-8 w-8" />, title: 'Workflow Automation', description: 'Orchestrate complex tasks and manage MCP servers with intuitive automation.' },
  { icon: <Terminal className="h-8 w-8" />, title: 'Developer Friendly', description: 'Comprehensive API and SDK for seamless integration into your projects.' },
  { icon: <Terminal className="h-8 w-8" />, title: 'High Performance', description: 'Optimized for speed with minimal resource consumption and instant feedback.' },
  { icon: <Terminal className="h-8 w-8" />, title: 'Extensible', description: 'Build custom plugins and extensions to tailor ECHOMEN to your needs.' },
];
