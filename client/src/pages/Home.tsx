...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300">
      ...
      {/* Performance Optimization: The CLI demo is isolated into its own component to prevent
          high-frequency state updates from re-rendering the entire Home page. */}
