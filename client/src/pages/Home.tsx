...
// Hoisted variants and data to prevent re-creation on every render
...
const NAV_ITEMS = ['Features', 'Demo', 'FAQ', 'Community'] as const;
      ...
      <section id="demo" className="py-20 md:py-32 bg-muted/30">
        <div className="container">
          ...
          >
            ...
            {/* Isolated CliDemo component prevents re-rendering the whole page during the terminal animation */}
            <CliDemo />
          </motion.div>
        </div>
      </section>
