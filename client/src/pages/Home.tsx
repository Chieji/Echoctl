 ...
 * 
 * Performance:
 * - Isolated high-frequency updates (CLI demo)
 * - Hoisted static data and animation variants
 * - Removed unused hooks
 */

// --- Static Data and Variants (Hoisted for Performance) ---

const NAV_ITEMS = ['Features', 'Demo', 'FAQ', 'Community'];
