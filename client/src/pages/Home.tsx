...
// Hoisted Static Data & Variants to prevent re-allocation on re-render
...
/**
 * CliDemo Component - Optimized to isolate frequent state updates
 * Prevents the entire Home page from re-rendering during the simulation
 */
function CliDemo() {
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300">
      ...
      {/* Interactive CLI Demo - Isolated to separate component */}
      <CliDemo />
