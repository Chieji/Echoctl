 ...
 * This component isolates the high-frequency state updates of the CLI simulation.
 * By moving `cliOutput` and `isRunningDemo` state here, we prevent the entire
 * Home page from re-rendering every 100ms during the simulation,
