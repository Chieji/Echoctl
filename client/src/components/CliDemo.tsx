 ...
 * Isolates high-frequency state updates (cliOutput) to this sub-component.
 * Prevents the entire Home page from re-rendering every 100ms during the simulation.
 */
export const CliDemo = React.memo(() => {
