 ...
 * This component isolates the high-frequency state updates (100ms interval)
 * during the CLI simulation to prevent the entire Home page from re-rendering.
 * Hoisting static data and simulation logic here keeps the main thread
 * efficient and the UI responsive.
 */
