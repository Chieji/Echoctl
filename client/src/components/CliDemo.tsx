 ...
 * CLI Demo Component
 *
 * OPTIMIZATION: Extracted into a standalone component to isolate frequent state updates
 * during the demo simulation. This prevents the entire Home page from re-rendering
 * every 100ms when the CLI output updates.
 */
